...
export default class playGame2 extends Phaser.Scene {
    constructor() {
        super("PlayGame2");
    }
    create() {
         ...
         */
        this.labelScore = this.add.text(80, 20, "Score: " + this.score, {
            font: "30px Cambria",
            fill: "#000000"
        });
        /**
         ...
         */
        this.labelLives = this.add.text(270, 20, "Lives: " + this.bird.lives, {
            font: "30px Cambria",
            fill: "#000000"
        });

        this.add.text(460, 20, "Level: 2" , {
            font: "30px Cambria",
            fill: "#000000"
    ...
    console.log(time);
        ...
        if (this.bird.lives > 0) {
            ...
            //colocar stop no time para 30 segundos
            //const time = 30;
            /*if(this.scene.now() >= time*1000)
            {
                this.bird.lives=0;
            }*/
